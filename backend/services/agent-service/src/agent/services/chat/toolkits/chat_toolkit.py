...
from agent.services.chat.tools.before_research_tool import BEFORE_RESEARCH_TOOL_SPECS
...
from agent.services.chat.tools.market_tool import MARKET_TOOL_SPECS
