...
export const personaResults: Record<string, PersonaResult> = {
  DELIVERY: {
    ...
    recommendedDistricts: ["1114066", "1103065"], // 마포, 이태원
  ...
  BALANCED: {
    ...
    recommendedDistricts: ["1123064", "1101061"], // 강남, 종로
  ...
  PREMIUM: {
    ...
    recommendedDistricts: ["1104066", "1114066"], // 성동, 마포
